...
Summary: This module absorbs the "Production MAX" deployment from the legacy `arton` project. You will deploy Gemma 4 in production using the Modular MAX engine.
